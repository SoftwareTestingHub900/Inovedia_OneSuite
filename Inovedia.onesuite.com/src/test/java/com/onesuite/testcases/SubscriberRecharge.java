...
public class SubscriberRecharge extends TestBase {
	  ...
	  driver.findElement(By.xpath(OR.getProperty("Username"))).sendKeys("Naomi");
	...
	public void Recharge() throws InterruptedException {
		...
		driver.findElement(By.xpath(OR.getProperty("EnterAmount"))).sendKeys("100");
		driver.findElement(By.xpath(OR.getProperty("Countinuebtn"))).click();
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("ValidatedRechargeSection"))),"Valiadted Recharge Section on Che kout page");
		log.info("Valiadted Recharge Section");
		driver.findElement(By.xpath(OR.getProperty("PaywithCardbtn"))).click();
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("PayInvoiceValidate"))),"Valiadted Pay Invoice form");
		...
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("SuccessfullybuyBalance"))),"Validate Success popup");
