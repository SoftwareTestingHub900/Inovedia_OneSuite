...
public class UpdateSubscriberProfile extends TestBase {
	 ...
	 * driver.findElement(By.xpath(OR.getProperty("Username"))).sendKeys("Tess");
	...
	//	WebElement Addfile = driver.findElement(By.xpath(OR.getProperty("UploadProfilebtn")));
		//Addfile.sendKeys("C:\\Users\\Usman\\OneDrive\\Desktop\\Pics\\637576810772775043_Un-Named.jpg");
		driver.findElement(By.xpath(OR.getProperty("UploadProfilebtn"))).sendKeys("C:\\Users\\Usman\\OneDrive\\Desktop\\Pics\\637576810772775043_Un-Named.jpg");
		Thread.sleep(7000);
